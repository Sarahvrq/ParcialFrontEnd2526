...
(()=>{
    const e = new Error("Cannot find module './CocktailInfo'");
...
const CocktailList = (t0)=>{
    ...
    if ($[0] !== "e14dcd425a0176d1708f6b745f4867a96d699c2895b00094b348f68bce2b1818") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e14dcd425a0176d1708f6b745f4867a96d699c2895b00094b348f68bce2b1818";
    }
    const { cocktails } = t0;
    let t1;
    if ($[1] !== cocktails) {
...
function _temp(cocktail) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$VS__projects$2f$PracticaParcialFront$2f$Cocktail$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CocktailCajita, {
        cocktail: cocktail
...
//# sourceMappingURL=Desktop_VS%20projects_PracticaParcialFront_Cocktail_src_f030b2b5._.js.map